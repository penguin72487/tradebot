...
with torch.no_grad():
    ...
    for i in range(len(data) - seq_length - 1):
        ...
        predicted_prices.append(input_tensor[0, -1, 0].item() * predicted)  # 取出最後一個時間步的 'close' 價格
...
# plt.plot(predicted_prices, label='Predicted Prices', linestyle= 'dotted', color='orange')
